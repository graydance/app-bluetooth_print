      ...
      public static Vector<Byte> mapToReceipt(Map<String, Object> config, List<Map<String, Object>> list) {
            ...
            for (Map<String, Object> m : list) {
                  ...
                  if ("text".equals(type)) {
                        ...
                        Log.e(TAG, "******************* x: " + aPos + ", relativeX: " + rPos + ", fontZoom: "
                                    + fontZoom);
      ...
      public static Vector<Byte> mapToLabel(Map<String, Object> config, List<Map<String, Object>> list) {
            ...
            for (Map<String, Object> m : list) {
                  ...
                  if ("text".equals(type)) {
                        ...
                        // 打印繁体
                        // tsc.addUnicodeText(10,32, LabelCommand.FONTTYPE.TRADITIONAL_CHINESE,
                        // LabelCommand.ROTATION.ROTATION_0, LabelCommand.FONTMUL.MUL_1,
                        // LabelCommand.FONTMUL.MUL_1,"BIG5碼繁體中文字元","BIG5");
                        // 打印韩文
                        // tsc.addUnicodeText(10,60, LabelCommand.FONTTYPE.KOREAN,
                        // LabelCommand.ROTATION.ROTATION_0, LabelCommand.FONTMUL.MUL_1,
                        // LabelCommand.FONTMUL.MUL_1,"Korean 지아보 하성","EUC_KR");
                  } else if ("barcode".equals(type)) {
